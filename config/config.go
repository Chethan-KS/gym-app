...
type Configurations struct {
	...
	Crypto             *cryptoConfigurations
	Auth               *authConfigurations
	Client             *ClientConfigurations
	AppConfig          *appConfigurations
	ClientConfig       *AuthConfiguration
	Kafka              *kafkaConfigurations
	Retries            *RetryConfigurations
	CronJobSchedule    *CronJobScheduleConfigurations
	PdfConfig          *PdfConfigurations
	EmailNotifications *EmailNotificationConfigurations
	TopCategories      *TopCategoryConfig
}
